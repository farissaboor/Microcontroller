...
LCD_RS      EQU   $80             ; LCD reset signal, pin PE7
            ...
            ORG   $3000
hex1        FCB   $AB             ; first byte, prints as 'A' and 'B'
hex2        FCB   $CD             ; second byte, prints as 'C' and 'D'
...
MainLoop    JSR   clrLCD          ; clear LCD & home cursor
            ...
            LDAA  #0              ; FIX: load immediate 0 into A
...
;*******************************************************************
;*         ([Y] x 50us)-delay subroutine. E-clk=50us     *
;*******************************************************************
